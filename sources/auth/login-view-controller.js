...
const SERVICE_NAME = 'LoginViewControllerService';///todo: not hardcoded
const API_URL = 'api/auth';///todo: not hardcoded
const DEBUG = true;

export class LoginViewController extends DHXView {
    constructor(parent) {
        super(parent);
